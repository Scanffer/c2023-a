...
void store_read() {
    FILE *fp = NULL;
    fp = fopen("C:\\Users\\scanffer\\CLionProjects\\c2023-a\\level1\\p10_warehouse\\warehouse.txt", "r");
    sum = 1;
    int flag = 1;
    while (flag) {
...
void store_upload() {
    FILE *fp = fopen("C:\\Users\\scanffer\\CLionProjects\\c2023-a\\level1\\p10_warehouse\\warehouse.txt", "w");
    for (int i = 1; i <= sum; i++) {
